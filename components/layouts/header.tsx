                ...
                <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                    ...
                    <li className="menu nav-item relative">
                        <Link href="/produk" className="nav-link">
                            <div className="flex items-center">
                                <IconMenuWidgets className="shrink-0" />
                                <span className="px-1">{t('Produk')}</span>
                            </div>
                        </Link>
                    </li>
                    <li className="menu nav-item relative">
                        <Link href="/transaksi" className="nav-link">
                            <div className="flex items-center">
                                <IconMenuInvoice className="shrink-0" />
                                <span className="px-1">{t('Transaksi')}</span>
                            </div>
                        </Link>
                    </li>
                    <li className="menu nav-item relative">
                        <Link href="/pengeluaran" className="nav-link">
                            <div className="flex items-center">
                                <IconMenuDragAndDrop className="shrink-0" />
                                <span className="px-1">{t('Pengeluaran')}</span>
                            </div>
                        </Link>
                    </li>
                    <li className="menu nav-item relative">
